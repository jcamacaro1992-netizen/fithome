// Search queries prioritize the @sergioorduz channel.
// Candidates are pre-curated IDs tried first (no API key needed).
// If all fail, YouTube API is searched using the query.
